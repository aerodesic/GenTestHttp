...
function gt_network_config_dialog_show() {
  if (has_class('dialog-box', 'hidden')) {
    ...
    send_gt('nm/list', function(results) {
      ...
      send_gt('config/attributes/network.regulatory', function(country_code_attributes) {
        ...
        tbody.appendChild(create_dialog_table_combo('Connections',  'w-connections', available_list.sort(), 'gt_network_config_connection_selected()'));
        ...
        // Security type
        tbody.appendChild(create_dialog_table_combo('Security',     'w-security', [ 'Yes', 'No'], 'gt_network_config_security_selected()'));
    
        // Mode
        tbody.appendChild(create_dialog_table_entry('Key',          'w-key', 'password'));
    
        // Show pw visible button
        tbody.appendChild(create_dialog_table_checkbox('Show Key',  'w-showpw', 'gt_network_config_show_pw(this)', false));
        ...
        buttonrow.appendChild(create_dialog_button('Connect', 'dialog_button', gt_network_config_button_connect));
        buttonrow.appendChild(create_dialog_button('Delete',  'dialog_button', gt_network_config_button_delete));
        buttonrow.appendChild(create_dialog_button('Save', '   dialog_button', gt_network_config_button_save));
        buttonrow.appendChild(create_dialog_button('Cancel',  'dialog_button', gt_config_button_done));
...
function gt_network_config_security_selected() {
...
function gt_network_config_connection_selected(list) {
...
// Show/Hide password.
function gt_network_config_show_pw(item) {
...
function gt_network_config_button_connect() {
...
function gt_network_config_button_delete() {
  var connection = get_value('w-connections');
...
function gt_config_button_done() {
...
function gt_network_config_button_save() {
  if (get_value('w-security') === 'Yes' && get_value('w-key') === '') {
    alert("Password required when security is enabled.")
...
function gt_edit_configuration_dialog(varname, extra_info, buttons, action) {
...
function gt_edit_configuration(params, extra_info, extra_writes) {
  gt_edit_configuration_dialog(params, extra_info,
                        [ 'Apply', 'Save', 'Cancel' ],
                        function(event) {
...
///////////////////////////////////////////////////////////////////////////////////////////////
function gt_change_password() {
  alert("Not implemented.")
}

///////////////////////////////////////////////////////////////////////////////////////////////
function gt_edit_users() {
  alert("Not implemented.")
}
...
window['onload']                        = gt_initialize;
window['onunload']                      = gt_shutdown;
window['onresize']                      = gt_resize;
